...
INSERT INTO roles (id, name, display_name, description, is_system, created_at) VALUES
  (gen_random_uuid(), 'super_admin', 'Super Admin', 'Full system access, cannot be deleted', true, NOW()),
  (gen_random_uuid(), 'admin',       'Admin',       'Manage quizzes, users, sessions',       true, NOW()),
  (gen_random_uuid(), 'moderator',   'Moderator',   'Review & moderate content',             true, NOW()),
  (gen_random_uuid(), 'creator',     'Quiz Creator','Create & manage own quizzes',           false, NOW()),
  (gen_random_uuid(), 'player',      'Player',      'Join and play quizzes',                 false, NOW());
...
INSERT INTO permissions (id, resource, action, description, created_at) VALUES
  (gen_random_uuid(), 'users',      'list',        'View user list', NOW()),
  (gen_random_uuid(), 'users',      'view',        'View user detail', NOW()),
  (gen_random_uuid(), 'users',      'create',      'Create new user', NOW()),
  (gen_random_uuid(), 'users',      'update',      'Edit user info', NOW()),
  (gen_random_uuid(), 'users',      'delete',      'Delete user', NOW()),
  (gen_random_uuid(), 'users',      'assign_role', 'Assign roles to users', NOW()),
  (gen_random_uuid(), 'roles',      'list',        'View role list', NOW()),
  (gen_random_uuid(), 'roles',      'view',        'View role detail', NOW()),
  (gen_random_uuid(), 'roles',      'create',      'Create new role', NOW()),
  (gen_random_uuid(), 'roles',      'update',      'Edit role', NOW()),
  (gen_random_uuid(), 'roles',      'delete',      'Delete role', NOW()),
  (gen_random_uuid(), 'quizzes',    'list',        'View quiz list', NOW()),
  (gen_random_uuid(), 'quizzes',    'view',        'View quiz detail', NOW()),
  (gen_random_uuid(), 'quizzes',    'create',      'Create quiz', NOW()),
  (gen_random_uuid(), 'quizzes',    'update',      'Edit quiz', NOW()),
  (gen_random_uuid(), 'quizzes',    'delete',      'Delete quiz', NOW()),
  (gen_random_uuid(), 'quizzes',    'publish',     'Publish quiz', NOW()),
  (gen_random_uuid(), 'quizzes',    'moderate',    'Moderate quiz content', NOW()),
  (gen_random_uuid(), 'sessions',   'list',        'View session list', NOW()),
  (gen_random_uuid(), 'sessions',   'view',        'View session detail', NOW()),
  (gen_random_uuid(), 'sessions',   'create',      'Create session', NOW()),
  (gen_random_uuid(), 'sessions',   'start',       'Start a session', NOW()),
  (gen_random_uuid(), 'sessions',   'end',         'End a session', NOW()),
  (gen_random_uuid(), 'sessions',   'delete',      'Delete session', NOW()),
  (gen_random_uuid(), 'reports',    'view',        'View reports', NOW()),
  (gen_random_uuid(), 'reports',    'export',      'Export reports', NOW()),
  (gen_random_uuid(), 'audit_logs', 'list',        'View audit log list', NOW()),
  (gen_random_uuid(), 'audit_logs', 'view',        'View audit log detail', NOW()),
