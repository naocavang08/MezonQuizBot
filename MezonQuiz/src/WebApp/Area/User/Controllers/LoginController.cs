    ...
    public class LoginController : ControllerBase
    {
        ...
        public async Task<IActionResult> MezonCallback([FromBody] MezonAuthRequest request)
        {
            ...
            if (string.IsNullOrWhiteSpace(clientId) || string.IsNullOrWhiteSpace(clientSecret) || string.IsNullOrWhiteSpace(configuredRedirectUri))
            {
                ...
                return StatusCode(500, "Cấu hình OAuth của server chưa đầy đủ.");
            }
            ...
            if (!tokenResponse.IsSuccessStatusCode)
            {
                ...
                return StatusCode((int)tokenResponse.StatusCode, new { Message = "Lỗi khi đổi token từ Mezon.", Details = errorContent });
            }
                ...
                string.IsNullOrWhiteSpace(accessTokenNode.GetString()))
            {
                ...
                return StatusCode(502, new { Message = "Phản hồi token từ Mezon không hợp lệ.", Details = tokenRaw });
            }
            ...
            if (!userInfoResponse.IsSuccessStatusCode)
            {
                ...
                return StatusCode((int)userInfoResponse.StatusCode, new { Message = "Không thể lấy thông tin người dùng từ Mezon.", Details = userInfoError });
            }
            ...
            if (userInfo.ValueKind != JsonValueKind.Object)
            {
                ...
                return StatusCode(502, new { Message = "Phản hồi userinfo từ Mezon không hợp lệ.", Details = userInfoRaw });
            }
            ...
            if (string.IsNullOrWhiteSpace(mezonUserId) && string.IsNullOrWhiteSpace(username))
            {
                ...
                return StatusCode(502, new { Message = "Không thể xác định người dùng từ Mezon." });
            }
